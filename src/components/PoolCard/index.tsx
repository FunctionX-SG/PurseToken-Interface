...
export default function PoolCard(props: any) {
  ...
  const lpTokenAddress =
    poolInfo.lpAddresses[
      chainId?.toString() as keyof typeof poolInfo.lpAddresses
    ];
          ...
          >
            <span>
              ...
              <div>
                  ...
                  {aprloading ? (
                    <div style={{ marginTop: "8px" }}>
                      <span className="">
                        <small>
                          APR:{" "}
                          {parseFloat(apr.toString()).toLocaleString("en-US", {
                ...
                <span className="">
                  <small>
                    Bonus Multiplier: {poolInfo.bonusMultiplier}x &nbsp;
                    <ReactPopup
                      trigger={(open) => (
                    ...
                    >
                      <span className="textInfo">
                        <small>
                          Multiplier represents X times of PURSE rewards each
                          farm will receive.
                        </small>
                        <br />
                      </span>
                      <span className="textInfo mt-2">
                        <small>
                          For example, a 1x farm receives 1x PURSE per block
                          while a 40x farm receives 40x PURSE per block.
                        </small>
                        <br />
                      </span>
                      <span className="textInfo mt-2">
                ...
                <span className=" ">
                  <small>
                    Total LP Staked:{" "}
                    {parseFloat(
                      formatBigNumber(props.stakeBalance, "ether")
                ...
                <span className=" ">
                  <small>
                    {aprloading ? (
                      <div className="">
                        TVL: ${" "}
                        {parseFloat(tvl.toString()).toLocaleString("en-US", {
                          maximumFractionDigits: 0,
                        })}{" "}
                      </div>
                    ) : (
