...
export default function Main() {
  ...
  return (
    <div id="content" className="mt-4">
              ...
              <tbody>
                {isFetchMainDataLoading ? (
                  ...
                  <tr>
                    ...
                    <td>
                      $
                      {parseFloat(PURSEPrice.toString()).toLocaleString(
                        "en-US",
      ...
      <br /> <br />
      <div
        className="text mt-5 common-title"
      ...
      >
        ...
        <div>
          Farm Cap Reward Token: Total capacity reward tokens will be minted by
          this farm.
        </div>
      </div>
      <div
